...
public class AlertNoBtnPopup extends PopupWindow implements View.OnClickListener {
    ...
    public AlertNoBtnPopup(Context context, String alertContext) {
    ...
    public AlertNoBtnPopup(Context context, String alertContext, String buttonText) {
        this.context = context;
        this.alertContext = alertContext;
    ...
    public AlertNoBtnPopup(Context context, String alertContext, String buttonText_1, String buttonText_2) {
        this.context = context;
        this.alertContext = alertContext;
